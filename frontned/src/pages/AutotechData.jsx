...
const AutotechData = () => {
  useBackendOnline();
  const dashboardImg = getCloudinaryUrl("dashboard-img-one.webp");
  const autodataDiagrame = getCloudinaryUrl("autodata_diagrame.webp");
  const chassisImg = getCloudinaryUrl("auto_network_img01.webp");
  const chassisImgSlide = getCloudinaryUrl("auto_network_img_slide.webp");
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-12 items-center relative z-10">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-tight">
                An Online OE Information Tool Offering Exclusive, Precise
              ...
              <p className="text-gray-400 text-base md:text-lg leading-relaxed max-w-2xl">
                Whether it is vehicle maintenance, diagnostics or repair, our
                omnipresent tool brings it all to your fingertips! Our manuals
                are the bible for garages and auto-centres serving modern
                vehicles in the UK.
              </p>
              <div className="pt-2">
                <Link
          ...
          <div className="max-w-7xl mx-auto relative z-10 space-y-10">
            ...
            <div className="grid md:grid-cols-2 gap-8 text-gray-400 text-sm md:text-base leading-relaxed">
              <div className="space-y-4">
                <p>
                  At Autotechdata, we bring a world-class, state-of-the-art OE
                  Information Tool that enables you to manage your garage in a
                  more efficient way while staying on the go.
                </p>
                <p>
                  With our iconic OE information tool, you can manage every
                  aspect of your business. This OE information equips your
                  garage with technical prowess by providing distinct, accurate
                  technical specifications.
                </p>
              </div>
              <div className="space-y-4">
                <p>
                  Our ubiquitous tool puts everything at your fingertips,
                  whether it's car maintenance, diagnostics, or repair! Our
                  manuals are the bible for garages and auto-centres in the UK
                  that service current automobiles.
                </p>
                <p>
                  You can count on accuracy that will far exceed your
                  expectations. Autotechdata's precise wiring diagrams,
                  benchmark diagnostics, and repair information will appeal to
                  qualified, experienced technicians and mechanics, as well as
                  any other car specialist.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-12 lg:gap-16 items-center relative z-10">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <p className="text-gray-400 text-base leading-relaxed">
                It is easy for factory correct OE information to meet the eyes,
                as you can witness in the slide show above. If the evident
                precision in the stated technical information, illustrations,
                and drawings successfully stirs your interest, click the button
                below and allow us to elaborate further on this amazing tool and
                its features!
              </p>
              <div className="pt-4">
                <Link
          ...
          <div className="max-w-7xl mx-auto relative z-10 space-y-12">
            <div className="text-center space-y-4 max-w-3xl mx-auto">
              ...
              <p className="text-gray-400 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
                Choose a flexible, one-off lookup bundle to fit your workshop's
                volume. Pay only for the data lookups you need, with no
              ...
              {[
                ...
                >
                  <div className="space-y-2">
                    ...
                    <div className="text-3xl font-black text-blue-400 pt-2">
                      £{tier.price}
                    </div>
