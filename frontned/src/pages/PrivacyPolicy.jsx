        ...
        <section className="relative py-20 px-6 md:px-12 overflow-hidden text-center z-10">
          ...
          >
            ...
            <p className="text-gray-300 text-base md:text-lg max-w-xl mx-auto px-4 leading-relaxed">
              Read the standard terms of service, cookies policies, log files specifications, and legal exclusions of Auto Garage Network.
            </p>
          </motion.div>
        </section>
          ...
          >
            <div>
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and any or all Agreements: <strong>"Client"</strong>, <strong>"You"</strong> and <strong>"Your"</strong> refers to you, the person accessing this website and accepting the Company's terms and conditions. <strong>"The Company"</strong>, <strong>"Ourselves"</strong>, <strong>"We"</strong> and <strong>"Us"</strong>, refers to Auto Garage Network. <strong>"Party"</strong>, <strong>"Parties"</strong>, or <strong>"Us"</strong>, refers to both the Client and ourselves, or either the Client or ourselves. Any use of the above terminology or other words in the singular, plural, capitalisation and/or he/she or they, are taken as interchangeable and therefore as referring to same.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <h2 className="text-xl md:text-2xl font-bold text-white flex items-center gap-2 border-b border-white/5 pb-2">
                  <span className="text-indigo-400">1.</span> Exclusions and Limitations
                </h2>
                <p className="text-sm text-gray-300 leading-relaxed">
                  The information on this web site is provided on an "as is" basis. To the fullest extent permitted by law, this Company:
                </p>
                <ul className="list-disc pl-5 space-y-2 text-sm text-gray-300 leading-relaxed">
                  <li>Excludes all representations and warranties relating to this website and its contents or which is or may be provided by any affiliates or any other third party, including in relation to any inaccuracies or omissions in this website and/or the Company's literature.</li>
                  ...
                  <li>Does not however exclude liability for death or personal injury caused by its negligence. The above exclusions and limitations apply only to the extent permitted by law. None of your statutory rights as a consumer are affected.</li>
                </ul>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <h2 className="text-xl md:text-2xl font-bold text-white flex items-center gap-2 border-b border-white/5 pb-2">
                  <span className="text-indigo-400">5.</span> Links to and from this Website
                </h2>
                <h4 className="font-extrabold text-white text-sm uppercase tracking-wider">Links to this website</h4>
                <p className="text-sm text-gray-300 leading-relaxed">
                  You may not create a link to any page of this website without our prior written consent. If you do create a link to a page of this website you do so at your own risk and the exclusions and limitations set out above will apply to your use of this website by linking to it.
                </p>
                <h4 className="font-extrabold text-white text-sm uppercase tracking-wider pt-2">Links from this website</h4>
                <p className="text-sm text-gray-300 leading-relaxed">
                ...
                <p className="text-sm text-gray-300 leading-relaxed">
                  Please be aware that we are not responsible for the privacy practices, or content, of these sites. We encourage our users to be aware when they leave our site & to read the privacy statements of these sites. This Company will not accept any responsibility for any loss or damage in whatever manner, howsoever caused, resulting from your disclosure to third parties of personal information.
                </p>
              </div>

              <div className="space-y-4">
                <h2 className="text-xl md:text-2xl font-bold text-white flex items-center gap-2 border-b border-white/5 pb-2">
                  <span className="text-indigo-400">6.</span> Intellectual Property & General
                </h2>
                <h4 className="font-extrabold text-white text-sm uppercase tracking-wider">Copyright Notice</h4>
                <p className="text-sm text-gray-300 leading-relaxed">
                  Copyright and other relevant intellectual property rights exists on all text relating to the Company's services and the full content of this website.
                </p>
                <h4 className="font-extrabold text-white text-sm uppercase tracking-wider pt-2">General Terms</h4>
                <p className="text-sm text-gray-300 leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <h2 className="text-xl md:text-2xl font-bold text-white flex items-center gap-2 border-b border-white/5 pb-2">
                  <span className="text-indigo-400">7.</span> Notification of Changes
                </h2>
                <p className="text-sm text-gray-300 leading-relaxed">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-[#050816]/40 p-6 rounded-2xl border border-white/5 space-y-2 text-sm text-gray-300">
                  <p className="text-white font-bold text-base">Auto Garage Network Ltd</p>
                  <p>Address: The Chestnuts, 46 Middle Lane, Nether Broughton, LE14 3HD</p>
                  <p>Email: <a href="mailto:info@autogaragenetwork.com" className="text-indigo-400 hover:text-indigo-300 font-semibold">info@autogaragenetwork.com</a></p>
