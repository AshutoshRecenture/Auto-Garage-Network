          ...
          >
            <div>
              ...
              <p className="text-sm md:text-base leading-relaxed">
                ...
                <strong>Auto Garage Network Ltd</strong> uses cookies and
                similar technologies (such as web beacons, tracking pixels, and
                tags) to recognize you when you visit our website at
                autogaragenetwork.com and associated garage portals.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm md:text-base leading-relaxed mb-4">
                Cookies are small data files that are stored on your computer or
                mobile device when you visit a website. They are widely used by
                website owners to make websites work, or work more efficiently,
                as well as to provide reporting information.
              </p>
              <p className="text-sm md:text-base leading-relaxed">
                Cookies set by the website owner (in this case, Auto Garage
                Network Ltd) are called "first-party cookies". Cookies set by
                ...
                interactive chat, advertising, and analytics).
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm md:text-base leading-relaxed">
                ...
                and target the interests of our users to enhance their platform
                experience.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm md:text-base leading-relaxed mb-4">
                ...
                through our websites and the purposes they perform are outlined
                below:
              </p>
              <ul className="space-y-4">
                <li className="bg-[#050816]/30 p-5 rounded-2xl border border-white/5">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    ...
                    available through our website and platform, such as
                    accessing secure areas, database querying, and booking diary
                    states.
                  </p>
                </li>
                <li className="bg-[#050816]/30 p-5 rounded-2xl border border-white/5">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed mb-2">
                    ...
                    form to help us understand how our website is being used,
                    the efficacy of our marketing campaigns, or to help us
                    customize our platforms.
                  </p>
                  <p className="text-indigo-300 text-sm leading-relaxed font-semibold">
                    * Analytics systems: We utilize Google Analytics (via
                    G-3VXE9GRF5S and AW-16474078641 tracking tags), Microsoft
                    Clarity (wd3xkp0w0f), and Insightful-cloud-7 tracking
                    scripts to record user behavior patterns safely.
                  </p>
                </li>
                <li className="bg-[#050816]/30 p-5 rounded-2xl border border-white/5">
                  <strong className="text-white text-base block mb-2">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    ...
                    example, your choice of language, region, or active
                    Dark/Light theme).
                  </p>
                </li>
              </ul>
            ...
            <div>
              ...
              <p className="text-sm md:text-base leading-relaxed mb-4">
                ...
                functionality and secure areas of our platforms may be
                restricted.
              </p>
              <p className="text-sm md:text-base leading-relaxed mb-4">
            ...
            <div>
              ...
              <p className="text-sm md:text-base leading-relaxed">
                ...
                tracking technologies, please email us at{" "}
                <a
